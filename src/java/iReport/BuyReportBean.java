...
public class BuyReportBean {
    ...
    public BuyReportBean(Date d, Date e) {
        this.d = d;
        this.e = e;
    }
    ...
    public void viewBuyReport() {
        try {
            ...
            JRDataSource  jrdataSource = new JRBeanCollectionDataSource(dao.findAllBuyReport(d, e));
            String s = FacesContext.getCurrentInstance().getExternalContext().getRealPath("/report/report7.jrxml");
