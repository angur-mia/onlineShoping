                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="features_items"><!--features_items-->
                            <h2 class="title text-center">Men's Product</h2>
                            ...
                            <c:forEach var="data" items="${demo}" begin="199" end="199">
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <a href="getMensFandi123" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>&nbsp;Men's Fendi Items</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>    
                            ...
                            <c:forEach var="data" items="${demo}" begin="200" end="200">
                                <div class="col-sm-4">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="${data.proUrl}" alt="" />
                                                <a href="getGuessPage" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>&nbsp;Men's Guess Products</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>      
                            ...
                            <c:forEach var="data" items="${demo}" begin="201" end="201">
                                <div class="col-sm-4">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="${data.proUrl}" alt="" />
                                                <a href="getValentinoPage" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>&nbsp;Mens's Valentino products</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>      
                            ...
                            <c:forEach var="data" items="${demo}" begin="202" end="202">
                                <div class="col-sm-4">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center" style="height: 400px;  width: 250px;">
                                                <img src="${data.proUrl}" alt=""  style="height: 70%"/>
                                                <a href="getDiorPage" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>&nbsp;Dior Items</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>      
                            ...
                            <c:forEach var="data" items="${demo}" begin="203" end="203">
                                <div class="col-sm-4">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center" style="height: 400px;  width: 250px;">
                                                <img src="${data.proUrl}" alt=""  style="height: 70%"/>
                                                <a href="getVersacePage" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>&nbsp;Varsace Products</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>      
