                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="features_items"><!--features_items-->
                            <h2 class="title text-center">Sports Items</h2>
                            ...
                            <c:forEach var="data" items="${demo}" begin="196" end="196">
                                <div class="col-sm-4">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img class="mycss" src="${data.proUrl}" alt="" />
                                                <a href="getNikePage" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>&nbsp;Nike Products</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>    
                            ...
                            <c:forEach var="data" items="${demo}" begin="198" end="198">
                                <div class="col-sm-4">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="${data.proUrl}" alt="" />
                                                <a href="getUnderArmor" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>&nbsp;Under-armor Products</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>      
                            ...
                            <c:forEach var="data" items="${demo}" begin="197" end="197">
                                <div class="col-sm-4">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="${data.proUrl}" alt="" />
                                                <a href="geAdidasPage" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>&nbsp;Adidas Products</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>      
