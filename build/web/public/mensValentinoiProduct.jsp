                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="features_items"><!--features_items-->
                            <h2 class="title text-center">Valentino Products</h2>

                            <c:forEach var="data" items="${demo}" begin="0" end="8" >
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center" style="height: 400px;  width: 250px;">
                                                ...
                                                <h2>$${data.proPrice}</h2>
                                                <p>${data.proName}</p>
                                                <a href="saveChoiceForMensFendi?&sesId=${user}&proId=${data.proId}&proName=${data.proName}&proUrl=${data.proUrl}&proPrice=${data.proPrice}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                            </div>
                                            <div class="product-overlay">
                                                <div class="overlay-content">
                                                    <h2>$${data.proPrice}</h2>
                                                    <p>${data.proName}</p>
                                                    <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="choose">
                                            <ul class="nav nav-pills nav-justified">
                                                ...
                                                <li><a href="saveWishlistFromMensValentino?&userEmail=${parUser}&proId=${data.proId}&proName=${data.proName}&proUrl=${data.proUrl}&proPrice=${data.proPrice}&proQty=${data.proQty}"><i class="fa fa-plus-square"></i>Add to wishlist</a></li>
                                                <li><a href="goDetailPage?&sesId=${user}&proId=${data.proId}&proName=${data.proName}&subCatId=${data.subCatId}&proUrl=${data.proUrl}&proPrice=${data.proPrice}&proQty=${data.proQty}&proDesc=${data.proDesc}"><i class="fa fa-eye"></i>View Details</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>  
