                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="features_items"><!--features_items-->
                            <h2 class="title text-center">Women's product</h2>
                            ...
                            <c:forEach var="data" items="${demo}" begin="204" end="204">
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img class="mycss" src="${data.proUrl}"/>
                                                <a href="getWomensFendiPage" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>&nbsp;Fendi Products</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>    
                            ...
                            <c:forEach var="data" items="${demo}" begin="205" end="205">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img class="mycss" src="${data.proUrl}" />
                                                <a href="getWomensGuessPage" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>&nbsp;Guess Products</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>   
                            ...
                            <c:forEach var="data" items="${demo}" begin="206" end="206">
                                <div class="col-sm-4">

                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center" style="height: 400px;  width: 250px;" >
                                                <img class="mycss" src="${data.proUrl}" alt="" style="height: 70%" />
                                                <a href="getWomensValantinoPage" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>&nbsp;Valentino Proudcts</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>    
                            ...
                            <c:forEach var="data" items="${demo}" begin="207" end="207">
                                <div class="col-sm-4">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center" style="height: 400px;  width: 250px;" >
                                                <img class="mycss" src="${data.proUrl}" alt="" style="height: 70%" />
                                                <a href="getWomensDiorPage" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>&emsp;Dior Products</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>    
                            ...
                            <c:forEach var="data" items="${demo}" begin="208" end="208">
                                <div class="col-sm-4">
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center" style="height: 400px;  width: 250px;" >
                                                <img class="mycss" src="${data.proUrl}" alt="" style="height: 70%" />
                                                <a href="getWomensVersacePage" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>&nbsp;Versace Product</a>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade active in" id="tshirt" >
                                    <div class="col-sm-3">
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    <c:set var="h" value="resources/nike.jpg"/>
                                                    <img src="${h}" alt="" />
                                                    <h2>$56</h2>
                        ...
                        <div class="recommended_items"><!--recommended_items-->
                            ...
                            <div id="recommended-item-carousel" class="carousel slide" data-ride="carousel"><!-- css/main.css-->
